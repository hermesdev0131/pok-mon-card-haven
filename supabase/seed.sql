...
values
  ('00000000-0000-0000-0000-000000000000', 'ad000000-0000-0000-0000-000000000001', 'authenticated', 'authenticated', 'admin@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Admin GradedBR"}', now(), now());

-- 1.2 Sellers
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at)
values
  ('00000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000001', 'authenticated', 'authenticated', 'seller1@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"CardMaster BR"}',       '2022-03-15', now()),
  ('00000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000002', 'authenticated', 'authenticated', 'seller2@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"PokéCollector SP"}',    '2022-08-20', now()),
  ('00000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000003', 'authenticated', 'authenticated', 'seller3@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"TCG Premium"}',         '2024-11-01', now()),
  ('00000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000004', 'authenticated', 'authenticated', 'seller4@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Graded Cards BR"}',     '2021-06-10', now()),
  ('00000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000005', 'authenticated', 'authenticated', 'seller5@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"PokéRaro"}',            '2023-02-14', now()),
  ('00000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000006', 'authenticated', 'authenticated', 'seller6@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"MasterGrade TCG"}',     '2024-12-01', now());

-- 1.3 Buyers
insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at)
values
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000001', 'authenticated', 'authenticated', 'buyer1@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"João M."}',      now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000002', 'authenticated', 'authenticated', 'buyer2@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Pedro S."}',     now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000003', 'authenticated', 'authenticated', 'buyer3@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Ana L."}',       now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000004', 'authenticated', 'authenticated', 'buyer4@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Lucas R."}',     now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000005', 'authenticated', 'authenticated', 'buyer5@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Mariana F."}',   now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000006', 'authenticated', 'authenticated', 'buyer6@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Carlos T."}',    now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000007', 'authenticated', 'authenticated', 'buyer7@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Fernanda R."}',  now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000008', 'authenticated', 'authenticated', 'buyer8@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Bruno M."}',     now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000009', 'authenticated', 'authenticated', 'buyer9@seed.gradedbr.com',  crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Camila T."}',    now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000010', 'authenticated', 'authenticated', 'buyer10@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Rafael S."}',    now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000011', 'authenticated', 'authenticated', 'buyer11@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Ricardo L."}',   now(), now()),
  ('00000000-0000-0000-0000-000000000000', 'b0000000-0000-0000-0000-000000000012', 'authenticated', 'authenticated', 'buyer12@seed.gradedbr.com', crypt('Seed123!@#', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Fernanda M."}',  now(), now());

-- 1.4 Auth identities (required for login in Supabase v2+)
insert into auth.identities (id, user_id, identity_data, provider, provider_id, last_sign_in_at, created_at, updated_at)
values
  -- Admin
  ('ad000000-0000-0000-0000-000000000001', 'ad000000-0000-0000-0000-000000000001', jsonb_build_object('sub', 'ad000000-0000-0000-0000-000000000001', 'email', 'admin@seed.gradedbr.com'), 'email', 'ad000000-0000-0000-0000-000000000001', now(), now(), now()),
  -- Sellers
  ('a0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', jsonb_build_object('sub', 'a0000000-0000-0000-0000-000000000001', 'email', 'seller1@seed.gradedbr.com'), 'email', 'a0000000-0000-0000-0000-000000000001', now(), '2022-03-15', now()),
  ('a0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002', jsonb_build_object('sub', 'a0000000-0000-0000-0000-000000000002', 'email', 'seller2@seed.gradedbr.com'), 'email', 'a0000000-0000-0000-0000-000000000002', now(), '2022-08-20', now()),
  ('a0000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003', jsonb_build_object('sub', 'a0000000-0000-0000-0000-000000000003', 'email', 'seller3@seed.gradedbr.com'), 'email', 'a0000000-0000-0000-0000-000000000003', now(), '2024-11-01', now()),
  ('a0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000004', jsonb_build_object('sub', 'a0000000-0000-0000-0000-000000000004', 'email', 'seller4@seed.gradedbr.com'), 'email', 'a0000000-0000-0000-0000-000000000004', now(), '2021-06-10', now()),
  ('a0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000005', jsonb_build_object('sub', 'a0000000-0000-0000-0000-000000000005', 'email', 'seller5@seed.gradedbr.com'), 'email', 'a0000000-0000-0000-0000-000000000005', now(), '2023-02-14', now()),
  ('a0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000006', jsonb_build_object('sub', 'a0000000-0000-0000-0000-000000000006', 'email', 'seller6@seed.gradedbr.com'), 'email', 'a0000000-0000-0000-0000-000000000006', now(), '2024-12-01', now()),
  -- Buyers
  ('b0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000001', 'email', 'buyer1@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000001', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000002', 'email', 'buyer2@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000002', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000003', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000003', 'email', 'buyer3@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000003', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000004', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000004', 'email', 'buyer4@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000004', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000005', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000005', 'email', 'buyer5@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000005', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000006', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000006', 'email', 'buyer6@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000006', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000007', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000007', 'email', 'buyer7@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000007', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000008', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000008', 'email', 'buyer8@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000008', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000009', 'b0000000-0000-0000-0000-000000000009', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000009', 'email', 'buyer9@seed.gradedbr.com'),  'email', 'b0000000-0000-0000-0000-000000000009', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000010', 'b0000000-0000-0000-0000-000000000010', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000010', 'email', 'buyer10@seed.gradedbr.com'), 'email', 'b0000000-0000-0000-0000-000000000010', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000011', 'b0000000-0000-0000-0000-000000000011', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000011', 'email', 'buyer11@seed.gradedbr.com'), 'email', 'b0000000-0000-0000-0000-000000000011', now(), now(), now()),
  ('b0000000-0000-0000-0000-000000000012', 'b0000000-0000-0000-0000-000000000012', jsonb_build_object('sub', 'b0000000-0000-0000-0000-000000000012', 'email', 'buyer12@seed.gradedbr.com'), 'email', 'b0000000-0000-0000-0000-000000000012', now(), now(), now());
